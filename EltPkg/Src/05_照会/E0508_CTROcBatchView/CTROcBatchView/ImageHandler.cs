...
namespace CTROcBatchView
{
    public class ImageHandler
    {
        ...
        /// イメージコントロールの作成
        /// </summary>
        public bool CreateImageControl(TBL_TRBATCH bat, TBL_TRBATCHIMG img, TBL_IMG_PARAM imgparam, bool isFit = false)
        {
            ...
            // 画像ファイル読み込み
            this.HasImage = false;
            string _orgFilePath = GetImgFilePath(bat, img);
        ...
        /// イメージファイルパスを取得する
        /// </summary>
        private string GetImgFilePath(TBL_TRBATCH bat, TBL_TRBATCHIMG img)
        {
