...
namespace NCR.GeneralMainte {
    ...
    public class SearchList : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "NCR.GeneralMainte.SearchList.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSearchList : Component, ICachedReport {
