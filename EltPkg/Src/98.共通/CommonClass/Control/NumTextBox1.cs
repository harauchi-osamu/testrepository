...
namespace CommonClass
{
	...
	/// </summary>
    public abstract class NumTextBox1 : BaseTextBox
	{
		/// <summary>
		/// 必要なデザイナ変数です。
		/// </summary>
		...
		/// KeyDown処理モード
		/// </summary>
		private KEYDOWNMODE KeyDownMode = KEYDOWNMODE.NUMBER;

		internal NumTextBox1(KEYDOWNMODE mode) : base() {
			InitializeComponent();
			KeyDownMode = mode;
		}
...
//			base.OnKeyDown(e);		
			switch ( e.KeyCode ) {
                ...
                case Keys.Decimal:
					...
					if(KeyDownMode == KEYDOWNMODE.NUMBER)
                    {
						e.Handled = true;
						SendKeys.Send("000");
					}
