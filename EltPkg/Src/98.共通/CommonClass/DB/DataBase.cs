...
namespace CommonClass.DB
{
    public partial class DataBase
    {
        ...
        public void NewCommand(string QueryOrProcedure, CommandType Commandtype)
        {
            if (DBConvert.ToIntNull(System.Configuration.ConfigurationManager.AppSettings["LogLevel"]) > 75)
            {
        ...
        public virtual DbParameter CreateSqlParameter(string name, object dbtype, ParameterDirection direction, object value)
        {
            throw new Exception(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType.FullName + " is not implementened.");
        }
        
        public virtual DbParameter CreateSqlParameter(string name, object dbtype, ParameterDirection direction, object value, int size)
        {
            throw new Exception(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType.FullName + " is not implementened.");
        }
