...
namespace MainMenu
{
    ...
    public class Controller : ControllerBase
    {
        ...
        /// <summary>
        /// exe.config ファイルロックリトライ回数
        /// </summary>
        public int FileLockRetryCount { get; private set; } = 0;

        /// <summary>
        /// exe.config ファイルロックスリープタイム
        /// </summary>
        public int FileLockSleepTime { get; private set; } = 0;
        ...
        protected override bool CheckServerIni()
        {
            ...
            ChkParam(NCR.Server.ContractBankCd, "受託元銀行番号");
            ChkParam(NCR.Server.HandlingBankCdList, "設定可能な銀行一覧");
        ...
        public override bool CheckAppConfig()
        {
            ...
            FileLockRetryCount = GetAppSettingsInt("FileLockRetryCount", "ファイルロックリトライ回数");
            FileLockSleepTime = GetAppSettingsInt("FileLockSleepTime", "ファイルロックスリープタイム（ミリ秒）");
