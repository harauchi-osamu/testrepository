...
namespace PrintIcOcBkTotalList
{
    /// <summary>
    /// 持出バッチ別合計表画面
    /// </summary>
    public partial class PrintIcOcBkTotal : EntryCommonFormBase
    {
        private Controller _ctl = null;
        private MasterManager _masterMgr = null;
        private ItemManager _itemMgr = null;
        private CTRIcOcBkTotalListDataSet _ds = null;
        ...
        /// コンストラクタ
        /// </summary>
        public PrintIcOcBkTotal()
        {
            InitializeComponent();
            _ds = new CTRIcOcBkTotalListDataSet();
        }
        ...
        private void PrintList(bool isPreview)
        {
            ...
            // ヘッダー
            CTRIcOcBkTotalListDataSet.HeaderDataTable hTable = _ds.Header;
            CTRIcOcBkTotalListDataSet.HeaderRow hRow = hTable.NewHeaderRow();
            hRow.業務 = "業務：交換持帰";
            ...
            // フッター
            CTRIcOcBkTotalListDataSet.FooterDataTable fTable = _ds.Footer;
            CTRIcOcBkTotalListDataSet.FooterRow fRow = fTable.NewFooterRow();
        ...
        {
            // 明細
            CTRIcOcBkTotalListDataSet.DetailDataTable dTable = _ds.Detail;
            foreach (ItemManager.PrintDetail detail in details)
            {
                //明細データ処理
                CTRIcOcBkTotalListDataSet.DetailRow dRow = dTable.NewDetailRow();
                // 持出銀行
                dRow.持出銀行 = detail.OCBKNo.ToString("D4");
                // 持出銀行名
                dRow.持出銀行名 = _itemMgr.GetBank(detail.OCBKNo);
                // 明細総枚数
