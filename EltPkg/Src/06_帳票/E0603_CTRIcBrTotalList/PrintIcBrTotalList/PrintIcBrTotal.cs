...
namespace PrintIcBrTotalList
{
    ...
    /// 持出バッチ別合計表画面
    /// </summary>
    public partial class PrintIcBrTotal : EntryCommonFormBase
    {
        private Controller _ctl = null;
        private MasterManager _masterMgr = null;
        private ItemManager _itemMgr = null;
        private CTRIcBrTotalListDataSet _ds = null;
        ...
        /// コンストラクタ
        /// </summary>
        public PrintIcBrTotal()
        {
            InitializeComponent();
            _ds = new CTRIcBrTotalListDataSet();
        }
        ...
        private void PrintList(bool isPreview)
        {
            ...
            // ヘッダー
            CTRIcBrTotalListDataSet.HeaderDataTable hTable = _ds.Header;
            CTRIcBrTotalListDataSet.HeaderRow hRow = hTable.NewHeaderRow();
            hRow.業務 = "業務：交換持帰";
            //作成日
            ...
            // フッター
            CTRIcBrTotalListDataSet.FooterDataTable fTable = _ds.Footer;
            CTRIcBrTotalListDataSet.FooterRow fRow = fTable.NewFooterRow();
        ...
        {
            // 明細
            CTRIcBrTotalListDataSet.DetailDataTable dTable = _ds.Detail;
            foreach (ItemManager.PrintDetail detail in details)
            {
                //明細データ処理
                CTRIcBrTotalListDataSet.DetailRow dRow = dTable.NewDetailRow();
                // 支店番号
                dRow.支店番号 = detail.BRNo.ToString("D4");
                // 支店名
                dRow.支店名 = detail.BRName;
                // 明細総枚数
