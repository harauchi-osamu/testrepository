...
namespace PrintOcBrTotal
{
    ...
    /// 持出バッチ別合計表画面
    /// </summary>
    public partial class PrintBrTotal : EntryCommonFormBase
    {
        private Controller _ctl = null;
        private MasterManager _masterMgr = null;
        private ItemManager _itemMgr = null;
        private CTROcBrTotalListDataSet _ds = null;
        ...
        {
            InitializeComponent();
            _ds = new CTROcBrTotalListDataSet();
        }
        ...
        private void PrintList(bool isPreview)
        {
            ...
            // ヘッダー
            CTROcBrTotalListDataSet.HeaderDataTable hTable = _ds.Header;
            CTROcBrTotalListDataSet.HeaderRow hRow = hTable.NewHeaderRow();
            hRow.業務 = "業務：交換持出";
            //作成日
            ...
            // フッター
            CTROcBrTotalListDataSet.FooterDataTable fTable = _ds.Footer;
            CTROcBrTotalListDataSet.FooterRow fRow = fTable.NewFooterRow();
        ...
        {
            // 明細
            CTROcBrTotalListDataSet.DetailDataTable dTable = _ds.Detail;
            foreach (ItemManager.PrintDetail detail in details)
            {
                //明細データ処理
                CTROcBrTotalListDataSet.DetailRow dRow = dTable.NewDetailRow();
                // 店番
                dRow.店番 = detail.OCBRNo.ToString("D3");
                // 店名
                dRow.店名 = detail.OCBRName;
                // 明細総枚数
